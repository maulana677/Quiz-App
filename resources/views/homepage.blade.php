...
@section('content')
    <section class="py-5">
        <h2 class="text-center fw-bold mb-3 text-white">Selamat Datang di Quizz</h2>
        <p class="text-center text-dark text-secondary">
    ...
    <section>
        <h5 class="mb-0 text-white fw-bold mb-4">List Kuis</h5>
